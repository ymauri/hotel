...
class CheckoutControl extends StepControl
{
    ...
    public function setup()
    {
        ...
        $this->checkOutDate = ParseUtils::parseCheckOutDate($_POST['check_out_date'], array('check_booking_rules' => false, 'check_in_date' => $this->checkInDate));
    ...
    public function display($editBooking, $settings)
    {
        ...
        $bookedRooms->addFields(array(
            'from_date' => $editBooking->getCheckInDate(),
            'to_date'   => $editBooking->getCheckOutDate(),
            'booking'   => $editBooking
        ));

        mphb_get_template_part('edit-booking/last-checkout', array(
            'booking' => $editBooking,
        ...
        mphb_get_template_part('edit-booking/checkout-form', array(
