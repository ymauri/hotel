...
<div id="mphb-add-room-popup" class="mphb-popup mphb-hide">
    ...
    <div class="mphb-popup-body">
        <div class="mphb-header">
            <h2 class="mphb-title mphb-inline"><?php _e('Add Accommodation', 'motopress-hotel-booking'); ?></h2>
            <button class="mphb-close-popup-button dashicons dashicons-no-alt"></button>
        </div>
        <div class="mphb-content">
            <h2><?php _e('Accommodation Type', 'motopress-hotel-booking'); ?></h2>
            ...
            <h2><?php _e('Accommodation', 'motopress-hotel-booking'); ?></h2>
        ...
        <div class="mphb-footer">
            <button class="button button-primary button-hero mphb-submit-popup-button"><?php _e('Add', 'motopress-hotel-booking'); ?></button>
        </div>
    </div>
</div>
