...
class EditControl extends StepControl
{
    ...
    public function display($editBooking, $settings)
    {
        ...
        mphb_get_template_part('edit-booking/edit-dates', array(
        ...
        mphb_get_template_part('edit-booking/edit-reserved-rooms', array(
            'actionUrl'     => $settings['action_url'],
        ...
        mphb_get_template_part('edit-booking/add-room-popup', array(
